...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ONG european dedicat protecției migranților și refugiaților." },
      ...
      { property: "og:description", content: "ONG european dedicat protecției migranților și refugiaților." },
      { name: "twitter:description", content: "ONG european dedicat protecției migranților și refugiaților." },
