  ...
  head: () => ({
    meta: [
      { title: "Asociația Europa Protecția Migrației — ONG european" },
      {
        name: "description",
        content:
          "Asociația Europa Protecția Migrației — ONG european: asistență juridică, integrare și advocacy pentru migranți și refugiați. Mediaș, Sibiu.",
      },
      ...
      { property: "og:image", content: "https://avyron.eu/__l5e/assets-v1/12b61bca-8a53-4c57-b676-1701a99c4492/og-image.jpg" },
      ...
      { name: "twitter:image", content: "https://avyron.eu/__l5e/assets-v1/12b61bca-8a53-4c57-b676-1701a99c4492/og-image.jpg" },
    ],
